...
<Accordion title="Configuration options">
  ...
  <ParamField body="model" type="string | BaseChatModel" required>
    Model for generating summaries. Can be a model identifier string (e.g., `'openai:gpt-4.1-mini'`) or a `BaseChatModel` instance. See [`init_chat_model`](https://reference.langchain.com/python/langchain/models/#langchain.chat_models.init_chat_model\(model\)) for more information.
  </ParamField>

  <ParamField body="trigger" type="ContextSize | list[ContextSize] | None">
    Condition(s) for triggering summarization. Can be:

    * A single [`ContextSize`](https://reference.langchain.com/python/langchain/middleware/#langchain.agents.middleware.summarization.ContextSize) tuple (specified condition must be met)
    * A list of [`ContextSize`](https://reference.langchain.com/python/langchain/middleware/#langchain.agents.middleware.summarization.ContextSize) tuples (any condition must be met - OR logic)
...
<Accordion title="Configuration options">
  <ParamField body="model" type="string | BaseChatModel">
    Model for tool selection. Can be a model identifier string (e.g., `'openai:gpt-4.1-mini'`) or a `BaseChatModel` instance. See [`init_chat_model`](https://reference.langchain.com/python/langchain/models/#langchain.chat_models.init_chat_model\(model\)) for more information.
...
<Columns cols={2}>
  <Card title="Anthropic" href="/oss/python/integrations/middleware/anthropic" icon="https://mintcdn.com/langchain-5e9cc07a/8wmXSqnKSeY1Y03n/images/providers/anthropic-icon.svg?fit=max&auto=format&n=8wmXSqnKSeY1Y03n&q=85&s=535c3abb1cd4217abbf2c1767bf5ae87" arrow data-og-width="65" width="65" data-og-height="65" height="65" data-path="images/providers/anthropic-icon.svg" data-optimize="true" data-opv="3" srcset="https://mintcdn.com/langchain-5e9cc07a/8wmXSqnKSeY1Y03n/images/providers/anthropic-icon.svg?w=280&fit=max&auto=format&n=8wmXSqnKSeY1Y03n&q=85&s=806d760c55ea1aee1f6a22d97bd62f27 280w, https://mintcdn.com/langchain-5e9cc07a/8wmXSqnKSeY1Y03n/images/providers/anthropic-icon.svg?w=560&fit=max&auto=format&n=8wmXSqnKSeY1Y03n&q=85&s=2e3cfef0ea8474376f5330353662224b 560w, https://mintcdn.com/langchain-5e9cc07a/8wmXSqnKSeY1Y03n/images/providers/anthropic-icon.svg?w=840&fit=max&auto=format&n=8wmXSqnKSeY1Y03n&q=85&s=dedfb80db8f668c0f959168011099dd1 840w, https://mintcdn.com/langchain-5e9cc07a/8wmXSqnKSeY1Y03n/images/providers/anthropic-icon.svg?w=1100&fit=max&auto=format&n=8wmXSqnKSeY1Y03n&q=85&s=8f27375f169670754ca8388bdbf94aaf 1100w, https://mintcdn.com/langchain-5e9cc07a/8wmXSqnKSeY1Y03n/images/providers/anthropic-icon.svg?w=1650&fit=max&auto=format&n=8wmXSqnKSeY1Y03n&q=85&s=2a5af93098439f83772fd4a5b3d60883 1650w, https://mintcdn.com/langchain-5e9cc07a/8wmXSqnKSeY1Y03n/images/providers/anthropic-icon.svg?w=2500&fit=max&auto=format&n=8wmXSqnKSeY1Y03n&q=85&s=1a2fcaf7a611187680cddaf954edd2f2 2500w">
