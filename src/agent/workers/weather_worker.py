...
def create_weather_worker(settings: Settings | None = None):
...
def build_ask_weather_agent_tool(settings: Settings | None = None):
    weather_worker = create_weather_worker(settings=settings)
